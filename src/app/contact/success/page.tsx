    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-grow flex items-center justify-center py-20">
        <div className="text-center px-6 max-w-2xl">
          <h1 className="text-5xl md:text-6xl font-light text-[#8fc0e5] font-[family-name:var(--font-playfair)] mb-6">
            Bedankt!
          </h1>
          <p className="text-xl md:text-2xl text-gray-700 mb-10 leading-relaxed">
            Je bericht is succesvol verzonden.<br />
            We nemen zo snel mogelijk contact met je op.
          </p>
          <Link
            href="/"
            className="inline-block bg-[#8fc0e5] text-white px-10 py-4 rounded-md font-medium hover:bg-[#7ab0d8] transition-all text-lg uppercase"
          >
            Terug naar home
          </Link>
        </div>
