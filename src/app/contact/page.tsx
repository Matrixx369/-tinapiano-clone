...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      alert('Verbinding mislukt. Controleer je internet en probeer opnieuw.');
    } finally {
      ...
      <FadeInSection>
        <section className="bg-white py-16 lg:py-20">
          <div className="container mx-auto px-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-[#8fc0e5] text-center font-[family-name:var(--font-playfair)] tracking-tight mb-4">
              Contact
            </h1>
          </div>
        </section>
        ...
        <section className="py-20 lg:py-24 bg-white">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              {/* Left - Contact Info */}
              <div>
                <h2 className="text-2xl md:text-3xl font-light text-[#8fc0e5] mb-8 font-[family-name:var(--font-playfair)]">
                ...
                <div className="space-y-6 mb-12">
                  ...
                  <div>
                    <p className="text-gray-600 mb-2">
                      E-mailadres:{' '}
                      <a href="mailto:info@tinapiano.be" className="text-[#8fc0e5] hover:underline font-medium">
                        info@tinapiano.be
                      </a>
                    </p>
                    <p className="text-gray-600">
                      Telefoonnummer:{' '}
                      <a href="tel:+32488893408" className="text-[#8fc0e5] hover:underline font-medium">
                        +32 488 89 34 08
                      </a>
                    </p>
                  </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#8fc0e5] disabled:opacity-50"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full bg-[#8fc0e5] text-white px-8 py-3 rounded-md font-medium hover:bg-[#7ab0d8] transition-all duration-300 hover:shadow-xl uppercase text-lg disabled:opacity-50 disabled:cursor-not-allowed"
                  >
