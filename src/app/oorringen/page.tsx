      ...
      <main className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-light text-[#8fc0e5] mb-6">Oorringen</h1>
            <p className="text-gray-700 text-lg max-w-3xl mx-auto">
              Verfijn uw look met onze elegante collectie oorringen. Van subtiele studs tot opvallende hangers,
              elk paar is handgemaakt met aandacht voor detail en comfort.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              <div className="aspect-square relative">
                <Image
                  ...
                  alt="Gouden oorringen"
                  fill
                  className="object-cover"
                />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-medium text-gray-900 mb-2">Gouden Oorringen 18k</h3>
                <p className="text-gray-600">Elegante gouden oorringen met moderne uitstraling</p>
              </div>
            </div>

            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              <div className="aspect-square relative bg-gray-100 flex items-center justify-center">
                <p className="text-gray-500">Oorringen Collectie</p>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-medium text-gray-900 mb-2">Zilveren Hangers</h3>
                <p className="text-gray-600">Subtiele zilveren oorhangers voor elke gelegenheid</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl font-medium text-gray-900 mb-2">Statement Oorringen</h3>
                <p className="text-gray-600">Opvallende ontwerpen voor de moderne vrouw</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-8 md:p-12 text-center">
            <h2 className="text-3xl font-light text-[#8fc0e5] mb-6">Unieke oorringen op maat</h2>
            <p className="text-gray-700 leading-relaxed mb-8 max-w-2xl mx-auto">
              Van klassiek tot eigentijds - wij ontwerpen oorringen die perfect bij uw stijl passen.
              Elk paar wordt met de hand gemaakt volgens uw wensen.
            </p>
            <Link
              href="/contact"
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/oorringen" className="text-[#8fc0e5] font-medium">Oorringen</Link></li>
