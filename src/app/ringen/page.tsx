...
<section className="relative h-[600px] lg:h-[750px] overflow-hidden">
  ...
  />
      ...
      <FadeInSection>
        <section className="bg-[#8fc0e5] py-16">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl font-light text-gray-900 mb-6">Ringen</h1>
            <p className="text-gray-800 text-base leading-relaxed max-w-3xl mx-auto mb-8">
            ...
            <Link
              href="/contact"
              className="inline-block bg-gray-700 text-white px-6 py-3 rounded-md font-medium hover:bg-gray-600 transition-colors uppercase text-xl"
            >
              Contacteer ons
            </Link>
          </div>
      ...
      {/* Ring Gallery - Images perfectly centered */}
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-16">
              ...
              <div className="group cursor-pointer">
                <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 hover:scale-105">
                  ...
                  <div className="p-4 bg-[#8fc0e5]">
                    <p className="text-white text-base text-center">Geelgoud 18K met saffier</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group cursor-pointer">
                <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 hover:scale-105">
                  ...
                  <div className="p-4 bg-[#8fc0e5]">
                    <p className="text-white text-base text-center">Geelgoud 18K</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group cursor-pointer">
                <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 hover:scale-105">
                  ...
                  <div className="p-4 bg-[#8fc0e5]">
                    <p className="text-white text-base text-center">Sterlingsilver 925 met aquamarijn en citrien</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group cursor-pointer">
                <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 hover:scale-105">
                  ...
                  <div className="p-4 bg-[#8fc0e5]">
                    <p className="text-white text-base text-center">Witgoud 18K met groene saffier</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group cursor-pointer">
                <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 hover:scale-105">
                  ...
                  <div className="p-4 bg-[#8fc0e5]">
                    <p className="text-white text-base text-center">Sterlingsilver 925 met edelstenen</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group cursor-pointer">
                <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 hover:scale-105">
                  ...
                  <div className="p-4 bg-[#8fc0e5]">
                    <p className="text-white text-base text-center">Sterlingsilver 925 met aquamarijn</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group cursor-pointer">
                <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 hover:scale-105">
                  ...
                  <div className="p-4 bg-[#8fc0e5]">
                    <p className="text-white text-base text-center">Sterlingsilver 925 met citrien</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group cursor-pointer">
                <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 hover:scale-105">
                  ...
                  <div className="p-4 bg-[#8fc0e5]">
                    <p className="text-white text-base text-center">Sterlingsilver 925 met morganiet</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group cursor-pointer">
                <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 hover:scale-105">
                  ...
                  <div className="p-4 bg-[#8fc0e5]">
                    <p className="text-white text-base text-center">Sterlingsilver 925 met roségoud</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group cursor-pointer">
                <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 hover:scale-105">
                  ...
                  <div className="p-4 bg-[#8fc0e5]">
                    <p className="text-white text-base text-center">Sterlingsilver 925 met citrien en peridot</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group cursor-pointer">
                <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 hover:scale-105">
                  ...
                  <div className="p-4 bg-[#8fc0e5]">
                    <p className="text-white text-base text-center">Sterlingsilver 925</p>
                  </div>
                </div>
              </div>
              ...
              <div className="group cursor-pointer">
                <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 hover:scale-105">
                  ...
                  <div className="p-4 bg-[#8fc0e5]">
                    <p className="text-white text-base text-center">Sterlingsilver 925 met peridot</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Custom Ring Section - Black Background */}
      <FadeInSection delay={200}>
        <section className="bg-gray-900 py-16">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-light text-[#8fc0e5] mb-6">Op zoek naar een unieke ring?</h2>
