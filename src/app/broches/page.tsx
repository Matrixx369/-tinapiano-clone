      ...
      <main className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-light text-[#8fc0e5] mb-6">Broches</h1>
            <p className="text-gray-700 text-lg max-w-3xl mx-auto">
              Voeg een vleugje elegantie toe aan uw outfit met onze artistieke broches.
              Elk stuk is een kunstwerk op zich, perfect om uw persoonlijke stijl te benadrukken.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl font-medium text-gray-900 mb-2">Groene Broche</h3>
                <p className="text-gray-600">Artistieke broche met groene accenten</p>
              </div>
            </div>

            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              <div className="aspect-square relative bg-gray-100 flex items-center justify-center">
                <p className="text-gray-500">Broche Collectie</p>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-medium text-gray-900 mb-2">Vintage Broche</h3>
                <p className="text-gray-600">Klassieke broche met vintage uitstraling</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl font-medium text-gray-900 mb-2">Moderne Broche</h3>
                <p className="text-gray-600">Eigentijds ontwerp met unieke vormen</p>
              </div>
            </div>
          </div>

          {/* Custom Brooches Section */}
          <div className="bg-gray-50 rounded-lg p-8 md:p-12 text-center">
            <h2 className="text-3xl font-light text-[#8fc0e5] mb-6">Broches op maat</h2>
            <p className="text-gray-700 leading-relaxed mb-8 max-w-2xl mx-auto">
              Creëer een broche die uw verhaal vertelt. Van klassiek tot avant-garde -
              wij ontwerpen en maken broches die perfect bij uw stijl passen.
            </p>
            <Link
              href="/contact"
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/broches" className="text-[#8fc0e5] font-medium">Broches</Link></li>
              </ul>
            </div>
