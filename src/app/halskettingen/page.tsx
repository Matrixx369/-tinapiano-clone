...
export default function HalsketingenPage() {
  return (
      ...
      <main className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-light text-[#8fc0e5] mb-6">Halskettingen</h1>
            <p className="text-gray-700 text-lg max-w-3xl mx-auto">
              Ontdek onze verfijnde collectie halskettingen en hangers. Elk stuk is ontworpen om uw decolleté
              te benadrukken en uw persoonlijkheid uit te drukken.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              <div className="aspect-square relative">
                <Image
                  ...
                  alt="Halsketting met hanger en parel"
                  fill
                  className="object-cover"
                />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-medium text-gray-900 mb-2">Hanger met Parel</h3>
                <p className="text-gray-600">Elegante halsketting met parel hanger</p>
              </div>
            </div>

            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              <div className="aspect-square relative bg-gray-100 flex items-center justify-center">
                <p className="text-gray-500">Halsketting Collectie</p>
              </div>
              <div className="p-6">
                <h3 className="text-xl font-medium text-gray-900 mb-2">Gouden Ketting</h3>
                <p className="text-gray-600">Tijdloze gouden halsketting</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
              ...
              <div className="p-6">
                <h3 className="text-xl font-medium text-gray-900 mb-2">Statement Hanger</h3>
                <p className="text-gray-600">Opvallende hanger voor speciale gelegenheden</p>
              </div>
            </div>
          </div>

          {/* Custom Necklaces Section */}
          <div className="bg-gray-50 rounded-lg p-8 md:p-12 text-center">
            <h2 className="text-3xl font-light text-[#8fc0e5] mb-6">Halskettingen op maat</h2>
            <p className="text-gray-700 leading-relaxed mb-8 max-w-2xl mx-auto">
              Laat ons een halsketting ontwerpen die perfect bij u past. Van subtiele kettingen tot
              opvallende statement pieces - wij maken het mogelijk.
            </p>
            <Link
              href="/contact"
              className="inline-block bg-[#8fc0e5] text-white px-8 py-3 rounded-md font-medium hover:bg-[#7ab0d8] transition-colors uppercase"
            >
              Vraag een ontwerp aan
            </Link>
          </div>
        </div>
      </main>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/halskettingen" className="text-[#8fc0e5] font-medium">Halskettingen</Link></li>
